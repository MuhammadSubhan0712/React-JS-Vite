  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
        <div className="p-5 flex justify-between bg-blue-700 w-full position-absolute">
          <div className=" text-xl text-white">Code Craft Academy</div>
            ...
            <form onSubmit={handleSubmit(Submission)} className="space-y-6">
              <div className="grid grid-cols-2 gap-7">
                ...
                <label className="block">
                  ...
                  <select
                    {...register("laptop", {
                      required: "Laptop status is required",
                    })}
                    className={`select select-bordered w-full mt-1 ${
                      errors.laptop && "border-red-500"
                    }`}>
